...
app_include_js = [
    ...
    "/assets/rmax_custom/js/sales_invoice_pos_total_popup.v3.js?v=2",
    ...
    "/assets/rmax_custom/js/vat_validation.js?v=2",
    "/assets/rmax_custom/js/contact_validation.js",
    "/assets/rmax_custom/js/item_branch_user.js",
    "/assets/rmax_custom/js/branch_user_restrict.js?v=3"
]
...
doctype_js = {
    ...
    "Purchase Receipt": ["public/js/purchase receipt.js", "public/js/create_supplier.js"],
    ...
    "Purchase Invoice": ["public/js/purchase_invoice_doctype.js", "public/js/create_supplier.js"],
